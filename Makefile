...
bootstrap: tmp build
	...
	cd tmp/checkout_ui_extension; rm -r node_modules/@shopify/shopify-cli-extensions; cp -r ../../packages/shopify-cli-extensions node_modules/@shopify/shopify-cli-extensions
	cd tmp/product_subscription; yarn install 
	cd tmp/product_subscription; rm -r node_modules/@shopify/shopify-cli-extensions; cp -r ../../packages/shopify-cli-extensions node_modules/@shopify/shopify-cli-extensions
	cd tmp/checkout_post_purchase; yarn install 
	cd tmp/checkout_post_purchase; rm -r node_modules/@shopify/shopify-cli-extensions; cp -r ../../packages/shopify-cli-extensions node_modules/@shopify/shopify-cli-extensions
