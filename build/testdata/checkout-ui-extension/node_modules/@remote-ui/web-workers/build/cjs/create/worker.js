...
function createWorkerFactory(script) {
  var scriptUrl = utilities.createScriptUrl(script);

  function createWorker() {
    var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
        _ref$createMessenger = _ref.createMessenger,
        createMessenger = _ref$createMessenger === void 0 ? worker.createWorkerMessenger : _ref$createMessenger,
        endpointOptions = _rollupPluginBabelHelpers.objectWithoutProperties(_ref, ["createMessenger"]);

    if (scriptUrl) {
      var endpoint = rpc.createEndpoint(createMessenger(scriptUrl), endpointOptions);
    ...
    if (typeof script === 'function') {
      return new Proxy({}, {
        get: function get(_target, property) {
          return /*#__PURE__*/_rollupPluginBabelHelpers.asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
            var _ref3;
