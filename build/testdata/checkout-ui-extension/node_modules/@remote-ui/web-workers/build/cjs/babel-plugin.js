...
var DEFAULT_PACKAGES_TO_PROCESS = {
  '@remote-ui/web-workers': [{
    ...
    wrapperModule: path.resolve(__dirname, 'wrappers/expose.js.raw')
  }]
};
var loader = path.resolve(__dirname, 'webpack-parts/loader');
function workerBabelPlugin(_ref) {
  ...
  return {
    visitor: {
      ...
      ImportDeclaration: function ImportDeclaration(importDeclaration, state) {
        ...
        var _iterator = _rollupPluginBabelHelpers.createForOfIteratorHelper(importDeclaration.get('specifiers')),
            _step;
  ...
  function processBinding(binding, importOptions, state) {
    ...
    var _iterator2 = _rollupPluginBabelHelpers.createForOfIteratorHelper(callingReferences),
        _step2;
    ...
    try {
      var _loop2 = function _loop2() {
        ...
        var dynamicallyImported = _rollupPluginBabelHelpers.toConsumableArray(dynamicImports)[0].get('arguments')[0];
        ...
        var options = _rollupPluginBabelHelpers.objectSpread2(_rollupPluginBabelHelpers.objectSpread2({}, getLoaderOptions(leadingComments || [])), {}, {
      ...
      for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
        ...
        if (_rollupPluginBabelHelpers['typeof'](_ret2) === "object") return _ret2.v;
      }
    } catch (err) {
      _iterator2.e(err);
    } finally {
...
function getLoaderOptions(comments) {
  return comments.reduce(function (options, comment) {
    ...
    try {
      var _runInNewContext = vm.runInNewContext("(function(){return {".concat(value, "};})()")),
          name = _runInNewContext.webpackChunkName;

      return name ? _rollupPluginBabelHelpers.objectSpread2(_rollupPluginBabelHelpers.objectSpread2({}, options), {}, {
        name: name
      }) : options;
    } catch (_unused) {
      return options;
...
function normalize(packages) {
  return Object.keys(packages).reduce(function (all, pkg) {
    return _rollupPluginBabelHelpers.objectSpread2(_rollupPluginBabelHelpers.objectSpread2({}, all), {}, _rollupPluginBabelHelpers.defineProperty({}, pkg, packages[pkg].map(function (anImport) {
...
exports.DEFAULT_PACKAGES_TO_PROCESS = DEFAULT_PACKAGES_TO_PROCESS;
