import { asyncToGenerator as _asyncToGenerator, slicedToArray as _slicedToArray, toConsumableArray as _toConsumableArray, objectSpread2 as _objectSpread2 } from './_virtual/_rollupPluginBabelHelpers.js';
import { addHooks, WaterfallHook, createProjectPlugin, TargetRuntime, Runtime } from '@sewing-kit/plugins';
import { DEFAULT_PACKAGES_TO_PROCESS } from './babel-plugin.mjs';

var PLUGIN = 'Quilt.WebWorkers';
var addWorkerHooks = addHooks(function () {
  return {
...
function webWorkers() {
  ...
  return createProjectPlugin(PLUGIN, function (_ref) {
...
function createBabelConfigUpdater(runtime, configure, _ref5) {
  var _ref5$noop = _ref5.noop,
      defaultNoop = _ref5$noop === void 0 ? !runtime.includes(Runtime.Browser) : _ref5$noop,
  ...
  return /*#__PURE__*/function () {
    var _ref6 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(babelConfig) {
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return Promise.all([configure.remoteUiWorkerNoop.run(defaultNoop), configure.remoteUiWorkerApplyBabelToPackages.run(_objectSpread2(_objectSpread2({}, DEFAULT_PACKAGES_TO_PROCESS), applyBabelToPackages))]);
            ...
            case 2:
              ...
              return _context.abrupt("return", _objectSpread2(_objectSpread2({}, babelConfig), {}, {
                plugins: [].concat(_toConsumableArray((_babelConfig$plugins = babelConfig.plugins) !== null && _babelConfig$plugins !== void 0 ? _babelConfig$plugins : []), [[require.resolve('./babel-plugin'), {
                  noop: noop,
                  packages: packages
                }]])
              }));
...
function createWebpackPluginAdder(configure, _ref7) {
  ...
  return /*#__PURE__*/function () {
    var _ref8 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(plugins) {
      ...
      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _context2.next = 2;
              return Promise.all([import('./webpack-parts/index.mjs'), configure.remoteUiWorkerWebpackGlobalObject.run(webpackGlobalObject), configure.remoteUiWorkerWebpackPlugins.run(webpackPlugins)]);
            ...
            case 2:
              ...
              return _context2.abrupt("return", [].concat(_toConsumableArray(plugins), [new WebWorkerPlugin({
