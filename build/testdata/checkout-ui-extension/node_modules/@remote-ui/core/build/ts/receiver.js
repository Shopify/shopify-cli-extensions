...
function createRemoteReceiver() {
    ...
    const attachedNodes = new Map([[exports.ROOT_ID, root]]);
    const receive = createRemoteChannel({
        ...
        updateProps: (id, newProps) => {
            ...
            const oldProps = Object.assign({}, component.props);
    ...
    return {
        ...
        attached: {
            ...
            get({ id }) {
                var _a;
                return (_a = attachedNodes.get(id)) !== null && _a !== void 0 ? _a : null;
            },
    ...
    function flush() {
        return timeout !== null && timeout !== void 0 ? timeout : Promise.resolve();
    }
    function emit(event) {
        const listenersForEvent = listeners.get(event);
        if (listenersForEvent) {
