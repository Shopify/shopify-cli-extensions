...
exports.createRemoteRoot = void 0;
...
function createRemoteRoot(channel, { strict = true, components } = {}) {
    ...
    const remoteRoot = {
        ...
        createText(content = '') {
            const id = `${currentId++}`;
            const internals = { text: content };
            const text = Object.assign({ kind: types_1.KIND_TEXT, get text() {
                    return internals.text;
                }, updateText: (newText) => updateText(text, newText, internals, rootInternals) }, EMPTY_OBJECT);
...
function connected(element, { tops }) {
    var _a;
    return ((_a = tops.get(element)) === null || _a === void 0 ? void 0 : _a.kind) === types_1.KIND_ROOT;
}
...
function perform(element, rootInternals, { remote, local, }) {
    ...
    if (mounted &&
        (element.kind === types_1.KIND_ROOT || connected(element, rootInternals))) {
...
function updateProps(component, newProps, internals, rootInternals) {
    ...
    return perform(component, rootInternals, {
        remote: (channel) => {
            if (hasRemoteChange) {
                channel(types_1.ACTION_UPDATE_PROPS, component.id, normalizedNewProps);
            }
        },
        local: () => {
            ...
            internals.externalProps = strict
                ...
                : mergedExternalProps;
            internals.internalProps = Object.assign(Object.assign({}, internals.internalProps), normalizedNewProps);
