 ...
 */
function createEndpoint(initialMessenger, { uuid = defaultUuid, createEncoder = encoding_1.createBasicEncoder, callable, } = {}) {
    ...
    function handlerForCall(property) {
        return (...args) => {
            ...
            if (typeof property !== 'string' && typeof property !== 'number') {
                throw new Error(`Can’t call a symbol method on a remote endpoint: ${property.toString()}`);
            }
            const id = uuid();
    ...
    function terminate() {
        ...
        (_a = encoder.terminate) === null || _a === void 0 ? void 0 : _a.call(encoder);
