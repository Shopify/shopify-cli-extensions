import { slicedToArray as _slicedToArray, asyncToGenerator as _asyncToGenerator, toConsumableArray as _toConsumableArray, createForOfIteratorHelper as _createForOfIteratorHelper } from './_virtual/_rollupPluginBabelHelpers.js';
...
function createEndpoint(initialMessenger) {
  var _ref = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
      ...
      createEncoder = _ref$createEncoder === void 0 ? createBasicEncoder : _ref$createEncoder,
  ...
  var encoder = createEncoder({
    ...
    call: function call(id, args, retainedBy) {
      ...
      var _encoder$encode = encoder.encode(args),
          _encoder$encode2 = _slicedToArray(_encoder$encode, 2),
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 8:
              ...
              _ref2 = data[1], _ref3 = _slicedToArray(_ref2, 3), id = _ref3[0], _property = _ref3[1], args = _ref3[2];
            ...
            case 14:
              _context.t1 = encoder;
              _context.next = 17;
              return func.apply(void 0, _toConsumableArray(encoder.decode(args, [stackFrame])));

            case 17:
              _context.t2 = _context.sent;
              _encoder$encode5 = _context.t1.encode.call(_context.t1, _context.t2);
              _encoder$encode6 = _slicedToArray(_encoder$encode5, 2);
            ...
            case 34:
              _ref4 = data[1], _ref5 = _slicedToArray(_ref4, 1), callId = _ref5[0];
              callIdsToResolver.get(callId).apply(void 0, _toConsumableArray(data[1]));
              callIdsToResolver.delete(callId);
              return _context.abrupt("break", 60);

            case 38:
              _ref6 = data[1], _ref7 = _slicedToArray(_ref6, 1), _id = _ref7[0];
              encoder.release(_id);
              return _context.abrupt("break", 60);

            case 41:
              _ref8 = data[1], _ref9 = _slicedToArray(_ref8, 1), _callId = _ref9[0];
              callIdsToResolver.get(_callId).apply(void 0, _toConsumableArray(data[1]));
              callIdsToResolver.delete(_callId);
              return _context.abrupt("break", 60);

            case 45:
              _ref10 = data[1], _ref11 = _slicedToArray(_ref10, 3), _callId2 = _ref11[0], funcId = _ref11[1], _args = _ref11[2];
              _context.prev = 46;
              _context.next = 49;
            ...
            case 49:
              ...
              _encoder$encode7 = encoder.encode(result), _encoder$encode8 = _slicedToArray(_encoder$encode7, 2), _encoded = _encoder$encode8[0], _transferables = _encoder$encode8[1];
  ...
  function handlerForCall(property) {
    return function () {
      ...
      var _encoder$encode3 = encoder.encode(args),
          _encoder$encode4 = _slicedToArray(_encoder$encode3, 2),
